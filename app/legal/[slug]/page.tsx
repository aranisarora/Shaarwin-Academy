...
import { CONTACT_EMAIL, displayWhatsappNumber } from "@/lib/contact";
...
const pages: Record<string, { title: string; body: string[] }> = {
  terms: {
    ...
    body: [
      ...
      `Sharwin Table Tennis Academy, No. 594, 4th Cross, 7th Ward, Gundappa Beedi, Dommasandra, Bengaluru, Karnataka 562125. Reg. No. 38/DOM/CE/0013/2026. Questions: ${CONTACT_EMAIL} or WhatsApp ${displayWhatsappNumber()}.`,
    ],
  },
  privacy: {
