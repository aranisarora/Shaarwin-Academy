...
const pages: Record<string, { title: string; body: string[] }> = {
  terms: {
    ...
    body: [
      "Membership is billed quarterly in advance and renews automatically until cancelled. Cancelling stops the next renewal; access continues to the end of the paid quarter.",
      ...
      "Private coaching minutes are granted each quarter with the Private plan and expire at the end of that quarter. Minutes are debited when a session is booked and refunded for cancellations made more than 24 hours ahead.",
