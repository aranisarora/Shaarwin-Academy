...
const APPLY_MESSAGE =
  "Hi Sharwin TTA — I'd like to apply as a coach. Here are my playing videos, qualifications and years of experience:";
    ...
    <section className="mx-auto max-w-6xl px-6 py-20 md:py-36">
      <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <Reveal>
          ...
          <WhatsAppCta size="lg" className="mt-8" message={APPLY_MESSAGE}>
            Apply via WhatsApp
          </WhatsAppCta>
